...
def main(dim: int, n: int, test_size: int, seed: int):
    ...
    print(f"Sampling {n} random entries from dataset (seed={seed})")
    total_size = len(dataset)
    sampled_indices = rng.choice(total_size, size=n, replace=False)
...
if __name__ == "__main__":
    ...
    main(args.dim, args.n, args.test_size, args.seed)
